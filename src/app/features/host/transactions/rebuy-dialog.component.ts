    ...
    <section class="w-[min(92vw,30rem)] space-y-5 bg-neutral-950 p-5 text-neutral-50">
      ...
      <div class="grid grid-cols-2 gap-3 sm:grid-cols-3">
        @for (amount of presets; track amount) {
          <button
            type="button"
            class="rounded-lg bg-emerald-400 px-4 py-5 text-lg font-bold text-neutral-950 transition hover:bg-emerald-300"
      ...
      <div>
        ...
        <div class="mt-2 flex gap-2">
          ...
          <button
            ...
            class="rounded-lg bg-white px-4 py-3 font-semibold text-neutral-950 disabled:bg-neutral-700 disabled:text-neutral-400"
      ...
      <button
        type="button"
        class="w-full rounded-lg border border-white/10 px-4 py-3 font-semibold text-neutral-200 hover:bg-white/10"
